...
export class LabelApi extends runtime.BaseAPI {
     ...
     * Create a new label
     */
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Label>> {
        if (requestParameters.label === null || requestParameters.label === undefined) {
            throw new runtime.RequiredError('label','Required parameter requestParameters.label was null or undefined when calling create.');
        }
     ...
     */
    async getRaw(requestParameters: GetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Label>> {
     ...
     * Edit label info
     */
    async updateRaw(requestParameters: UpdateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Label>> {
        if (requestParameters.labelId === null || requestParameters.labelId === undefined) {
