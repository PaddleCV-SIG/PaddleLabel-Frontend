...
export class AnnotationApi extends runtime.BaseAPI {
     ...
     */
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Annotation>> {
     ...
     * Create a new annotation
     */
    async create(annotation: Annotation, requestId?: string, initOverrides?: RequestInit): Promise<Annotation> {
     ...
     */
    async getRaw(requestParameters: GetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Annotation>> {
     ...
     * Edit annotation
     */
    async updateRaw(requestParameters: UpdateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Annotation>> {
        if (requestParameters.annotationId === null || requestParameters.annotationId === undefined) {
     ...
     * Edit annotation
     */
    async update(annotationId: number, annotation: Annotation, initOverrides?: RequestInit): Promise<Annotation> {
