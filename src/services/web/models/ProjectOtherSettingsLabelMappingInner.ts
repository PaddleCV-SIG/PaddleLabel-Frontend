...
export function ProjectOtherSettingsLabelMappingInnerFromJSON(json: any): ProjectOtherSettingsLabelMappingInner {
    return ProjectOtherSettingsLabelMappingInnerFromJSONTyped(json, false);
}

export function ProjectOtherSettingsLabelMappingInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectOtherSettingsLabelMappingInner {
...
export function ProjectOtherSettingsLabelMappingInnerToJSON(value?: ProjectOtherSettingsLabelMappingInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
