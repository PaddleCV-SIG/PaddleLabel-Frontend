...
export function PaddlelabelApiControllerUserLoginRequestFromJSON(json: any): PaddlelabelApiControllerUserLoginRequest {
    return PaddlelabelApiControllerUserLoginRequestFromJSONTyped(json, false);
}

export function PaddlelabelApiControllerUserLoginRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaddlelabelApiControllerUserLoginRequest {
...
export function PaddlelabelApiControllerUserLoginRequestToJSON(value?: PaddlelabelApiControllerUserLoginRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
