...
export class TaskApi extends runtime.BaseAPI {
     ...
     */
    async addTagRaw(requestParameters: AddTagOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Tag>>> {
     ...
     * Add a new tag to the task
     */
    async addTag(taskId: string, requestId?: string, addTagRequest?: AddTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Tag>> {
        const response = await this.addTagRaw({ taskId: taskId, requestId: requestId, addTagRequest: addTagRequest }, initOverrides);
     ...
     * Create a new task
     */
    async createRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Task>> {
        const queryParameters: any = {};
     ...
     */
    async getRaw(requestParameters: GetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Task>> {
        if (requestParameters.taskId === null || requestParameters.taskId === undefined) {
     ...
     * Get info of a specific task
     */
    async get(taskId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Task> {
     ...
     * Your GET endpoint
     */
    async getAllRaw(requestParameters: GetAllRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Task>>> {
        const queryParameters: any = {};
     ...
     * Your GET endpoint
     */
    async getAll(orderBy?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Task>> {
     ...
     * Get all annotations of a task
     */
    async getAnnotations(taskId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Annotation>> {
     ...
     */
    async getDatasRaw(requestParameters: GetDatasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Data>>> {
        if (requestParameters.taskId === null || requestParameters.taskId === undefined) {
     ...
     * Get all datas of a task
     */
    async getDatas(taskId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Data>> {
     ...
     * Get all tags of the task
     */
    async getTags(taskId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Tag>> {
     ...
     * Delete a task and ALL DATA and ANNOTATIONS under the task.
     */
    async remove(taskId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Edit task info
     */
    async updateRaw(requestParameters: UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Task>> {
        if (requestParameters.taskId === null || requestParameters.taskId === undefined) {
     ...
     * Edit task info
     */
    async update(taskId: string, task: Task, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Task> {
