...
export class UserApi extends runtime.BaseAPI {
     ...
     * Add a new user
     */
    async createRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<User>> {
     ...
     */
    async getRaw(requestParameters: GetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<User>> {
     ...
     * Get info of a specific user
     */
    async get(uuid: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<User> {
     ...
     * Get all users
     */
    async getAllRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<User>>> {
        const queryParameters: any = {};
     ...
     * Login and get JWT
     */
    async paddlelabelApiControllerUserLoginRaw(requestParameters: PaddlelabelApiControllerUserLoginOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PaddlelabelApiControllerUserLoginRequestToJSON(requestParameters.paddlelabelApiControllerUserLoginRequest),
        }, initOverrides);
     ...
     * Login and get JWT
     */
    async paddlelabelApiControllerUserLogin(paddlelabelApiControllerUserLoginRequest?: PaddlelabelApiControllerUserLoginRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.paddlelabelApiControllerUserLoginRaw({ paddlelabelApiControllerUserLoginRequest: paddlelabelApiControllerUserLoginRequest }, initOverrides);
    }
     ...
     * Delete a user
     */
    async remove(uuid: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Edit user info
     */
    async update(uuid: string, user: User, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<User> {
